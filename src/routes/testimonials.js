      ...
      <div>
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                <p>"You are seriously the Weird Al of movies!"</p>
                <footer className="blockquote-footer">Christian Anthony, Actor</footer>
            </blockquote>
            </div>
          </div>
        </div>
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Paul Douglas Michnewicz, 
        ...
        <div className="d-flex justify-content-center">
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                <p>"I had the pleasure of working with Mr. Hurley in a production of Shakespeare's' "Titus Andronicus". 
                  I was consistently impressed with his unflagging energy and commitment to the process. 
                  His focus is laser-sharp and his desire to explore and develop within his role was very strong. 
                  His albinism may be a defining physical trait to other's but Dennis' nature and artistic curiosity dissolved any perceived imitations. 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">James Comtois, 
        ...
        <div className="d-flex justify-content-center">
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                <p>"Dennis Hurley is one of the most naturally gifted actors I've come across, and I've worked with a lot of actors over the years.  
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Laurel Beaversdorf, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Melanie Adelman, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Richard Brundage,  
        ...
        <div className="d-flex justify-content-center">
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                <p>"In a business (and a world) where we are all judged by how we look, Dennis Hurley has the unique talent of making it not matter.  
                ...
                <footer className="blockquote-footer">Brian "Duck" Mallard, 
        ...
        <div className="d-flex justify-content-center">
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                <p>"I consider Dennis Hurley to be a dynamic, hard working and talented individual destined for a fruitful career within the creative arts.  
                  I am honored to Have directed two of his original one acts, and directing him on stage, in a seperate production, 
                  I have come to appreciate his individual talents as both a playwright and an actor. 
                ...
                <footer className="blockquote-footer">Steve Brillon, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Matt Carbo, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Greg Bostwick, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Andrew Park, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">James R. Northrup, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">David S. Titus, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Dave DoCouto, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Aaron Howland, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Dan Truman, 
          ...
          <div className="card d-flex justify-content-center quoteCard">
            <div className="card-body">
              <blockquote className="blockquote mb-0">
                ...
                <footer className="blockquote-footer">Paul S. Haberman, 
