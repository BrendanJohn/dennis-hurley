...
const Socials = ( ) => {
  return (
    ...
    <div className="col-8 d-flex justify-content-center" id="socials">
          ...
          <SocialIcon style={{ height: 50, width: 50 }} className ="social-icon" url="http://dennishurley.tumblr.com/" />
          <SocialIcon style={{ height: 50, width: 50 }} className ="social-icon" url="http://instagram.com/itsdendo" />
          <SocialIcon style={{ height: 50, width: 50 }} className ="social-icon" url="http://www.facebook.com/dendocomedy" />
    </div>
    <div className="col">
    </div>
  </div>
